# AGROCROP
Smart Agricultural Assistance and Resource Platform

AGROCROP is a digital agriculture platform designed to support farmers with crop advisory, land rental, machinery access, weather insights, and government scheme information in a single application.

This repository currently contains the UI/UX prototype designed in Figma. Development is planned for the next phase.

Prototype Link

Figma Design:
https://www.figma.com/design/4Kintlkp1ag23OE9lIezev/AGROCROP?node-id=0-1&t=QcohPPThM3eIH3Sj-1

The prototype demonstrates complete user flow and feature structure.
